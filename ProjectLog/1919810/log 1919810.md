...
- 标识符相关:  
  ...
  - playid在追踪数据中的每场比赛并不唯一  
    ...
    - # 图
    - ![[Pasted image 20240501005922.png]]
...
![[Pasted image 20240501014908.png]]
![[Pasted image 20240501014919.png]]
![[Pasted image 20240501015148.png]]
![[Pasted image 20240501015155.png]]
...
- 实验结果: 不如LSTM/GRU
- # maybe 出图
- ![[Pasted image 20240501013441.png]]
- 实验结论:
...
- 试验结论:
    ...
    - ![[Pasted image 20240501024253.png]]
...
- ![[Pasted image 20240501025019.png]]
# tensorboard 截图
- 实验结论:
    - 实验用到的特征有:
        - passResult.json
        ...
        - ![[Pasted image 20240501025304.png]]
        - ![[Pasted image 20240501025408.png]]
...
# Na plot
![[Pasted image 20240501030447.png]]
### 4.2神经网络
...
这个已经在神经网络训练UI处实现，在训练完以后支持对该神经网络进行输入特征贡献分析，支持只对正确label分类，或者根据选择对每个选中的类执行输入特征贡献分析：![[b6d69c93affd0fe055f2b1415fe9a5a.png]]
...
![[Pasted image 20240501020603.png]]
![[Pasted image 20240501020628.png]]
![[Pasted image 20240501020619.png]]
![[Pasted image 20240501020740.png]]